...
![img](DDD重学第二遍/136512ac4c65b3f2ed4b2898b40965f6.136512ac.jpg)
...
![img](DDD重学第二遍/c597d53a1a1aeca274d355e8ac79cc1b.c597d53a.jpg)
...
![img](DDD重学第二遍/323c8aca1271cc043558dfd1f95f57fa.323c8aca.jpg)

案例 2：以序列化大对象的方式形成的人员实体对象，地址值对象被序列化成大对象 Json 串后，嵌入人员实体中。

![img](DDD重学第二遍/96253ac8bd1d93a2786b59d7b9c2c423.96253ac8.jpg)
...
![img](DDD重学第二遍/ac0b9db12b201f24c7b2c1e343a88e26.ac0b9db1.png)
...
​	这只是最简单的定义，并不能让我们真正理解它。那到底什么是**领域事件**？**领域事件的技术实现机制**是怎样的？这一讲，我们就重点解决这两个大的问题。
...
​	我们一起回顾一下前面设计聚合，讲到的聚合的一个设计原则：在边界之外使用最终一致性。一次事务最多只能更改一个聚合的状态。如果一次业务操作涉及多个聚合状态的更改，应采用领域事件的最终一致性。
...
​	我们一起回顾一下 [第 05 讲](https://zq99299.github.io/note-book2/ddd/01/05.html) 讲到的聚合的一个设计原则：在边界之外使用最终一致性。一次事务最多只能更改一个聚合的状态。如果一次业务操作涉及多个聚合状态的更改，应采用领域事件的最终一致性。
